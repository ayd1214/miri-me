...
[규칙]
1. 마감기한(dueDate): 'Due', '마감' 등으로 표기된 날짜를 최우선으로 찾으세요. 'Available until' 등은 마감일이 아닙니다. 만약 'Monday'처럼 요일이나 상대적 날짜가 적혀있다면, 오늘 날짜를 기준으로 가장 가까운 미래의 해당 날짜를 계산해서 YYYY-MM-DDTHH:MM:SS 형식으로 적어주세요.
